...
- **Short coding sessions (< 30 min)** — When you have limited time, spending half of it on structured discovery and design docs leaves little room for actual implementation. Easy-brainstorming gets to a decision in 1-2 messages.
...
Copy the `skills/easy-brainstorming` directory into your project's `.claude/skills/` folder, or reference it directly.
